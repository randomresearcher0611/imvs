...
`/user-interfaces` contains the source code for the 3D Slicer-based and OHIF-viewer based interfaces that the IMVS API can be plugged into.

`/api` contains the source code for the IMVS API server.

Weights: https://drive.google.com/drive/folders/15vMrdWoqKmGRZAw-BgdGOMOiLDl6lJ0V
